...
## Backend 
# continued from -> AirBnB clone - console project 
...
![AirBnB console](Readme_photoAndVideo/hbnb_step2.png)

![MySQL](Readme_photoAndVideo/download.png)
...
* Destroy an object
* Beside the console this repo has the static and dynamic web page which is a clone of AirBnB 
* It's the second version of AirBnB clone which has new features and also has database which is written by sql using sqlalchemy module and concept
...
## Environment
This project is interpreted/tested on Ubuntu 22.04 LTS using python3.10
